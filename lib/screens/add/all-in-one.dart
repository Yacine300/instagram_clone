      ...
      body: Stack(
        children: [
          ...
          if (currentField == AddTransitionStory.routeName)
            const AddTransitionStory(),
          if (currentField == AddReel.routeName) const AddReel(),
          Positioned(
            bottom: 10,
                  ...
                  children: [
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                            color: currentField == GalleryScreen.routeName
                                ...
                                : Colors.grey,
                            letterSpacing: 1,
                            fontWeight: currentField == GalleryScreen.routeName
                                ? FontWeight.bold
                                : FontWeight.w400),
                      ),
                    ),
                    GestureDetector(
                      ...
                      child: Text(
                        "STORY",
                        style: TextStyle(
                            color: currentField == AddTransitionStory.routeName
                                ? Colors.white
                                : Colors.grey,
                            letterSpacing: 1,
                            fontWeight:
